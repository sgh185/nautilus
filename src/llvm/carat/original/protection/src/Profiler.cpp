        ...
        bool runOnModule (Module &M) override {
           ...
           //COUNTERS 
            ...
            /* ---------------- DATA FLOW ANALYSIS ---------------- */
                ...
                /*
                 * Apply the available carot DFA.
                 */
                DataFlowAnalysis dfa{};
                auto dfaResult = dfa.applyForward(&F, dfaGEN, dfaKILL, initIN, initOUT, computeIN, computeOUT);
            ...
            /* ---------------- DETERMINE GUARD PLACEMENT ---------------- */
                ...
                auto findPointToInsertGuard = [&redundantGuard, numNowPtr, dfaResult, &loopInfo, &scalarEvo, &storeInsts](Instruction *inst, Value *pointerOfMemoryInstruction) -> void {
#if OPTIMIZED
                                   /*
